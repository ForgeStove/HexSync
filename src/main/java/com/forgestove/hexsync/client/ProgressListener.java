...
public interface ProgressListener {
	 ...
	 */
	void onFileDownloadStart(String fileName, int fileIndex, int totalFiles);
	/**
	 * 当单个文件下载进度更新时调用
	 *
	 * @param fileName   当前正在下载的文件名
	 ...
	 */
	void onFileDownloadProgress(String fileName, int fileIndex, int totalFiles, int progress, long bytesRead, long totalBytes);
	/**
	 * 当单个文件下载完成时调用
	 *
	 ...
	 */
	void onFileDownloadComplete(String fileName, int fileIndex, int totalFiles, boolean success);
	/**
	 * 当所有文件下载完成时调用
	 *
